...
class UserAllLogsConverter(AllLogsConverter):
    ...
    def __init__(self, json_usrs_log_path = AllLogsConverter.json_usrs_log_path):
        ...
        """
        super(UserAllLogsConverter, self).__init__()
...
def main():
    ...
    json_usrs_log_path = "/speech/dbwork/mul/reco1/AppPrediction/SonyLogging/Logs/from_TKY/pulled_from_TKY/mixs_logs/json/usrs/"
    #json_usrs_log_path = "/speech/dbwork/mul/reco1/AppPrediction/SonyLogging/Logs/from_TKY/pulled_from_TKY/mixs_launcher_logs/json/"

    # all_in_one_log json file will be produced into json_usrs_log_path/${user}/all/all_in_one_log.json
    # this log is not validated, to validate use all_in_one_json_log_coordinator.py script
    converter = UserAllLogsConverter(json_usrs_log_path=json_usrs_log_path)
    converter.convert()
